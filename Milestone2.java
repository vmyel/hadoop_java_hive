...
public class Milestone2 {
    ...
    // Data Structures (Same as MS1, but will be filled with filtered data)
    ...
    public static void main(String[] args) {
        try {
            ...
            // MILESTONE 2A: Number of words per book (Stop Words Removed)
            System.out.println("================================================================================");
            System.out.println("MILESTONE 2a: Word Count per Book (Stop Words Removed)");
            System.out.println("================================================================================");
            System.out.printf("%-25s | %s%n", "Book Name", "Word Count");
            System.out.println("--------------------------+------------------");
            
            for (String book : bookTotalWordCounts.keySet()) {
                if (bookTotalWordCounts.get(book) > 50) { // Threshold to skip headers
            ...
            // MILESTONE 2B: Top 5 words per book (Stop Words Removed)
            System.out.println("======================================================================================");
            System.out.println("MILESTONE 2b: Top 5 Common Words per Book (Stop Words Removed)");
            System.out.println("======================================================================================");
            
            for (String book : bookTotalWordCounts.keySet()) {
                if (bookTotalWordCounts.get(book) < 50) continue; 

                // Print Book Name ONCE
            ...
            // MILESTONE 2C: Top 5 words in the whole Bible (Stop Words Removed)
            System.out.println("================================================================================");
            System.out.println("MILESTONE 2c: Top 5 Common Words in the Bible (Stop Words Removed)");
            System.out.println("================================================================================");
    ...
    private static void processLine(String book, String text) {
        ...
        // Track total valid words (excluding stop words) for this book
        bookTotalWordCounts.put(book, bookTotalWordCounts.getOrDefault(book, 0L) + validCount);
    }
